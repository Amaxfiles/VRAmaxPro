...
# --- DICTIONNAIRE DES TRADUCTIONS (INCLUS) ---
# (Ton dictionnaire reste identique, je ne le réécris pas ici pour gagner en lisibilité, 
# insère ton bloc LANGUAGES complet ici)
...
class VRAMaxApp(ctk.CTk):
    def __init__(self):
        ...
        # ... (tout ton code d'interface graphique ici) ...
